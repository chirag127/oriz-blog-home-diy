...
export default defineConfig({
  site: 'https://home-diy-blog.oriz.in',
          ...
          runtimeCaching: [
            {
              ...
              options: { cacheName: 'workbench-fonts', expiration: { maxEntries: 30 } },
            },
            {
            ...
            },
            {
              ...
              handler: 'StaleWhileRevalidate',
              options: { cacheName: 'workbench-static', expiration: { maxEntries: 200 } },
            },
          ],
        },
      }),
