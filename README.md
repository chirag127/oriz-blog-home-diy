# Home & DIY — `oriz-blog-home-diy`

> Make it, fix it, keep it — hands-on home projects and repairs that hold.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-home-diy?style=flat)](https://github.com/chirag127/oriz-blog-home-diy/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-home-diy)](https://github.com/chirag127/oriz-blog-home-diy/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-home-diy/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-home-diy/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Home & DIY** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A home-improvement and DIY blog — build guides, repairs, and maintenance walk-throughs written to be followed step by step.

- **Live site:** https://home-diy-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-home-diy
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-home-diy/ — the canonical, always-current site is **https://home-diy-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-home-diy/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>home-diy-blog.oriz.in"]
...
oriz-blog-home-diy/
├── src/
│   ├── content/blog/       # the DIY project guides (MDX/Markdown)
